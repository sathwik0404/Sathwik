...
public class Sathwik{
    public static void main(String[] args) {
        ...
        Product maxGstProduct = findMaxGstProduct(leatherWallet, umbrella, cigarette, honey);
        System.out.printIn("The product with maximum GST amount is " + maxGstProduct.name);
    ...
    private static Product findMaxGstProduct(Product... products) {
        ...
        double gstAmount = (product.unitPrice * product.gstPercentage) / 100.0;
